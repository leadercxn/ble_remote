set(DEFAULT_ARMGCC_PATH "/home/zcliu/.local/gcc-arm-none-eabi-7-2018-q2-update/bin")

find_program(ARMGCC_C_COMPILER arm-none-eabi-gcc
    PATH "${DEFAULT_ARMGCC_PATH}" ENV PATH NO_DEFAULT_PATH)
find_program(ARMGCC_C_OBJCOPY arm-none-eabi-objcopy
    PATH "${DEFAULT_ARMGCC_PATH}" ENV PATH NO_DEFAULT_PATH)
find_program(ARMGCC_C_SIZE arm-none-eabi-size
    PATH "${DEFAULT_ARMGCC_PATH}" ENV PATH NO_DEFAULT_PATH)

set(CMAKE_C_COMPILER ${ARMGCC_C_COMPILER})
...
set(CMAKE_C_FLAGS_MINSIZEREL     "-Os -g3 "  CACHE STRING "")
...
function (create_hex executable)
    add_custom_command(
        TARGET ${executable}
        POST_BUILD
        COMMAND ${ARMGCC_C_OBJCOPY} -O ihex ${CMAKE_CURRENT_BINARY_DIR}/${executable}.elf ${CMAKE_CURRENT_BINARY_DIR}/${executable}.hex
        BYPRODUCTS ${CMAKE_CURRENT_BINARY_DIR}/${executable}.hex)

    add_custom_command(
        TARGET ${executable}
        POST_BUILD
        COMMAND ${ARMGCC_C_SIZE} ${CMAKE_CURRENT_BINARY_DIR}/${executable}.elf)
